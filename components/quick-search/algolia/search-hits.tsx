    ...
    <div>
      {results.hits.length > 0 && (
        <div className="mt-8 grid overflow-auto px-1 lg:grid-cols-3 lg:gap-6">
          <section>
            <h3 className="text-h5 mb-6 border-b border-gray-200 pb-3">Categories</h3>
          ...
          <section>
            <h3 className="text-h5 mb-6 border-b border-gray-200 pb-3">Products</h3>
                    ...
                    <li key={objectID}>
                      ...
                      >
                        {image_url ? (
                          ...
                          <span className="text-h6 flex h-20 w-20 flex-shrink-0 items-center justify-center bg-gray-200 text-gray-500">
                            Photo
                          </span>
                        )}
          ...
          <section>
            <h3 className="text-h5 mb-6 border-b border-gray-200 pb-3">Brands</h3>
